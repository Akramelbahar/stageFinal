...
// API functions - You'll need to create these in src/api/roles.js
const getAllRoles = async () => {
  // Implement this function to fetch roles from your backend
  return { data: [] }; // Placeholder
};

const getAllPermissionModules = async () => {
  // Implement this function to fetch permission modules from your backend
  return { data: {} }; // Placeholder
};

const deleteRole = async (id) => {
  // Implement this function to delete a role
};
