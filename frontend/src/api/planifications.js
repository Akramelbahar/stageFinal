...
export const addInterventionToPlanification = async (planificationId, interventionId) => {
  try {
    // Check if the API endpoint matches the controller method - it should be addIntervention
...
export const removeInterventionFromPlanification = async (planificationId, interventionId) => {
  try {
    // Check if the API endpoint matches the controller method - it should be removeIntervention
    const response = await api.delete(`/planifications/${planificationId}/interventions`, {
