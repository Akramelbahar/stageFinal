...
const handleSubmit = async (e) => {
  ...
  console.log('Cout value:', formData.cout, typeof formData.cout);
  
  try {
    const dataToSubmit = { 
      nom: formData.nom,
      cout: parseFloat(formData.cout) || 0, // Ensure cout is a number
    ...
    if (isEditMode) {
      await updateRole(id, dataToSubmit);
    } else {
    ...
    setError('Erreur lors de l\'enregistrement du rôle: ' + (err.message || JSON.stringify(err)));
  } finally {
    setSaving(false);
  }
};
