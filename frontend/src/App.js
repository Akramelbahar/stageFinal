...
import PlanificationDetail from './pages/PlanificationDetail';
import ControleQualite from './pages/ControleQualite';
import ControleQualiteForm from './pages/ControleQualiteForm';
import ControleQualiteDetail from './pages/ControleQualiteDetail';
import Rapports from './pages/Rapports';
import RapportForm from './pages/RapportForm';
import RapportDetail from './pages/RapportDetail'; // Import the new component
        ...
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route 
              ...
              element={
                <ProtectedRoute requiredPermission="intervention-view">
                  <InterventionDetail />
                </ProtectedRoute>
              } 
            />
            ...
            <Route 
              ...
              element={
                <ProtectedRoute requiredPermission="planification-view">
                  <PlanificationDetail />
                </ProtectedRoute>
              } 
            />
            ...
            <Route 
              path="/controles/:id" 
              element={
                <ProtectedRoute requiredPermission="controle-view">
                  <ControleQualiteDetail />
                </ProtectedRoute>
              } 
            />
            <Route 
            ...
            />
            {/* Add the route for RapportDetail */}
            <Route 
              path="/rapports/:id" 
              element={
                <ProtectedRoute requiredPermission="rapport-view">
                  <RapportDetail />
                </ProtectedRoute>
              } 
            />
